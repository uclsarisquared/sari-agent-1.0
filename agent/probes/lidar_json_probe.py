...
Examples (run from the repository root):
    ...
    uv run python agent/probes/lidar_json_probe.py
    uv run python agent/probes/lidar_json_probe.py --uri ws://localhost:8080/commands
    uv run python agent/probes/lidar_json_probe.py --count 10 --delay 0.2
