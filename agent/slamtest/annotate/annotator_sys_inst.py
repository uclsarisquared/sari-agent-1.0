...
Follows the `agent/sys_inst.py` convention (module-level SYS_INST_* constants stating the
...
if __name__ == "__main__":
    # Eyeball the composed prompts: python slamtest/annotate/annotator_sys_inst.py
