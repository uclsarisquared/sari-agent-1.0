...
Run from anywhere (this script fixes up sys.path itself):
    ...
    python slamtest/drivers/explore.py --max-steps 20    # smoke test
    python slamtest/drivers/explore.py --max-steps 300   # full mapping run
...
def build_parser():
    ...
    parser.add_argument(
        "--output-dir",
        default=os.path.join(_SLAM_DIR, "output"),
    )
    parser.add_argument(
