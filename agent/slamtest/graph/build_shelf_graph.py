...
slamtest/plans/phase2_shelf_hugging_coverage.md for the design this implements.
...
Run from anywhere:
    python slamtest/graph/build_shelf_graph.py slamtest/output --tag final
"""
import argparse
import os
import sys
...
_THIS_DIR = os.path.dirname(os.path.abspath(__file__))        # slamtest/graph
