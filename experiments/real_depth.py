...
image_path = "C:\\Users\\Tristan Baclor\\Downloads\\test.jpg"
...
with open("real_depth_map.png", "wb") as f:
...
#save depth array
np.save("real_depth_array.npy", depth_array)
print("Depth array saved to real_depth_array.npy")

def get_distance_at_pixel(x, y, array_path="depth_array.npy"):
