...
wired into agent.py, the plan (slamtest/plans/phase6/phase6_long_horizon_tasks.md, "Things to
...
Everything measured is appended to plan6/step0_out/<run>/measurements.jsonl; screenshots land in the
...
class Probe:
    def __init__(self):
        from env import (RequestScreenshot, TransformHands, TransformAgent, SetHandsActive,
        ...
        self.run_dir = os.path.join(_THIS, "step0_out", datetime.now().strftime("%m%d_%H%M%S"))
