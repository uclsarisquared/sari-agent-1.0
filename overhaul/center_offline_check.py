...
convergence - that needs the live sim (rotate, re-screenshot, re-measure). Use eval_pickup.py
...
Usage:
    ...
    python center_offline_check.py "slamtest/output/captures/*_primary.png" --target "Piattos"
"""
import argparse
import glob
import math
...
def selftest():
    from perception import bbox_to_rotation, FOCAL_PX, ORIGINAL_WIDTH, ORIGINAL_HEIGHT
...
def check_image(path, target, repeat):
    from perception import _detect_bbox_px, bbox_to_rotation, ORIGINAL_WIDTH, ORIGINAL_HEIGHT
