...
CSV_PATH_2H = os.path.join(_THIS, "slamtest", "output", "placetests", "gate_checkout_2h.csv")
...
def main():
    ...
    from store_map import StoreMap, NavSession, checkout_held_item, checkout_held_items
