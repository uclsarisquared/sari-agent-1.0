...
OUT_DIR = os.path.join(_THIS, "slamtest", "output", "placetests")
...
def main():
    ...
    from env import (RequestLidarCenter, SetCrouch, SetHandsActive, RequestScreenshot,
    ...
    from perception import (center_to_counter, COUNTER_AIM_NORM,
                            center_to_scanner, SCANNER_AIM_NORM,
                            center_to_screen, read_text_in_box)
    from store_map import StoreMap, NavSession, go_to_counter
    from explore import step_agent
    from capture_walk import perpendicular_yaw, face     # slamtest on sys.path via store_map
