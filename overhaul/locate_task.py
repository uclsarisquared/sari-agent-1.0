...
def qwen_json(system, prompt, schema, image_paths=(), model="Qwen/Qwen3.6-27B", timeout=180.0,
...
def make_backend(args):
    ...
    return lambda system, prompt, schema, images=(): qwen_json(
        system, prompt, schema, images, model=args.model_name or "Qwen/Qwen3.6-27B",
