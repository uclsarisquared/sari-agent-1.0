...
Examples (run from the repository root):
    ...
    uv run python overhaul/probes/lidar_json_probe.py
    uv run python overhaul/probes/lidar_json_probe.py --uri ws://localhost:8080/commands
    uv run python overhaul/probes/lidar_json_probe.py --count 10 --delay 0.2
