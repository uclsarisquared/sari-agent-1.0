...
Every image lands under slamtest/output/centertests/<timestamp>/: center_before/after.png plus
...
_ROOT = os.path.dirname(_THIS)  # overhaul/ — runtime modules (env, perception) live there
...
CENTERTESTS_DIR = os.path.join(_ROOT, "screenshots", "centertests")
