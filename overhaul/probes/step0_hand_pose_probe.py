...
Needs the sim in Play mode on ws://localhost:8080.
    ...
    python probes/step0_hand_pose_probe.py
...
Everything measured is appended to slamtest/output/step0_out/<run>/measurements.jsonl; screenshots land in the
...
class Probe:
    def __init__(self):
        ...
        self.run_dir = os.path.join(_SLAM, "output", "step0_out", datetime.now().strftime("%m%d_%H%M%S"))
