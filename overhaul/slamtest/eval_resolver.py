...
layer's job, measured separately by the live trial set.
    ...
    python slamtest/eval_resolver.py --backend qwen        # needs $UCL_BASE_URL + $UCL_API
    python slamtest/eval_resolver.py --backend claude-cli
"""
import argparse
import json
import os
...
from store_map import StoreMap  # noqa: E402
...
def main():
    ...
    out = args.out or os.path.join(_THIS_DIR, "output",
