"""Frontier exploration driven by a VLM instead of A* - the measured control for explore.py.
    ...
    python slamtest/explore_vlm.py --max-steps 20                     # VLM smoke test
    python slamtest/explore_vlm.py --max-steps 300                    # full VLM run
    python slamtest/explore_vlm.py --planner astar --max-steps 300    # the A* control arm
