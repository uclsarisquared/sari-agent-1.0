...
MEASURED SETUP NOTES (all verified 2026-07, don't silently "improve" them):
  ...
  * `--json-schema` uses the same structured-output subset as the API: minItems/maxItems on the
    ...
    python slamtest/annotate_claude_cli.py slamtest/output/captures12/cp067_primary.png
    python slamtest/annotate_claude_cli.py slamtest/output/captures/cp028_primary.png --classify
"""
import argparse
import json
import os
