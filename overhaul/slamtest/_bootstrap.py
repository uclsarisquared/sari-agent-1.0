...
slamtest keeps FLAT imports by contract (see overhaul/CLAUDE.md): modules import
...
app/). Importing this module inserts onto sys.path (if absent): the overhaul
root (parent of slamtest), the slamtest dir itself, and each category subdir —
making every slamtest module importable flat and the overhaul packages
...
_SLAM_DIR = os.path.dirname(os.path.abspath(__file__))        # overhaul/slamtest
_OVERHAUL_DIR = os.path.dirname(_SLAM_DIR)                      # overhaul
