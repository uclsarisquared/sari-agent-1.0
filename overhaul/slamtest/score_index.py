...
intelligence into a number that is supposed to measure the INDEX, not the matcher.
    ...
    python slamtest/score_index.py
    python slamtest/score_index.py --products-tag final_shelf --verbose
"""
import argparse
import json
import os
...
def main():
    ...
    ap.add_argument("--output-dir", default=os.path.join(_THIS_DIR, "output"))
