...
# Entry point: `python evals/env_simulation.py` puts evals/ (not overhaul/) on sys.path, so the
# package imports below need the root added explicitly.
_OVERHAUL_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
